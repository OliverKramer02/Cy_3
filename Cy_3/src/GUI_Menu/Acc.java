...
/* 12:   */   
/* 13:   */   public Acc(CyAppAdapter adapter)
/* 14:   */   {
/* 15:20 */     super("According to centralities to be computed", adapter.getCyApplicationManager(), "network", adapter.getCyNetworkViewManager());
